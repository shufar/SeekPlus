...
public class AllJobListQuery: GraphQLQuery {
  public static let operationName: String = "AllJobList"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query AllJobList($limit: Int, $page: Int) { jobs(limit: $limit, page: $page) { __typename page size hasNext total jobs { __typename ...JobModel } } }"#,
  ...
  public struct Data: SeekPlusAPI.SelectionSet {
    ...
    public struct Jobs: SeekPlusAPI.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
